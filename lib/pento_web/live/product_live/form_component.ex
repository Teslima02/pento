defmodule PentoWeb.ProductLive.FormComponent do
  ...
  defp handle_progress(:image, entry, socket) do
    if entry.done? do
      ...
      # path = consume_uploaded_entries(socket, :images, &do_consume_upload(&1, &2, socket))
      # path =
      #   consume_uploaded_entries(
      #     socket,
      #     :image,
      #     &upload_static_file(&1, &2, socket)
      #   )
  ...
  # defp upload_static_file(%{path: path}, _entry, socket) do
